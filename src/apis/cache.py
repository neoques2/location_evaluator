...
def save_cached_geocoding(
    address: str, geocoding_data: Dict[str, Any], cache_duration_days: int = 30
) -> None:
    """
    ...
    cache_data = {
        "cache_info": {
            ...
            "expires": (
                datetime.now() + timedelta(days=cache_duration_days)
            ).isoformat(),
            "address": address,
...
def save_cached_route(
    ...
    cache_data = {
        "cache_info": {
            ...
            "grid_point": {"lat": origin_lat, "lon": origin_lon},
